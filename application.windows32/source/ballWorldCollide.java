...
public class ballWorldCollide extends PApplet {
...
public class Ball 
{
 ...
 Ball(float yi, float xi, float yveli, float xveli, float rad, float grav, float fric, float bou, int ballColor, float mass)
 {
...
public void display()
{
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "ballWorldCollide" };
    if (passedArgs != null) {
